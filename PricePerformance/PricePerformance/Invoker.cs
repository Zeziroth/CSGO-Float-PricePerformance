...
namespace PricePerformance
{
    static class Invoker
    {
        ...
        private delegate void _AddControl(Control parent, Control child);
        private delegate void _ClearControls(Control parent);
        ...
        public static void ClearControls(Control parent)
        {
            try
            {
                InvokedControl(parent, new _ClearControls(ClearControls), parent).Controls.Clear();
            }
            catch { }
        }
        public static void AddControl(Control parent, Control child)
        {
            try
            {
                InvokedControl(parent, new _AddControl(AddControl), parent, child).Controls.Add(child);
            }
            catch { }
        }
